 ...
 */
@Controller
@RequestMapping("/system/payChannelType")
public class PayChannelTypeController {
     ...
     * @since 2017-12-14
     */
    @AdminPermission(value = {"admin:paychanneltype:list"})
    @RequestMapping("/view")
    public String view() {
//	    PayChannelType pt = payChannelTypeService.queryChannelTypeByCode("alipay");
//	    System.out.println(pt+"=="+pt.getName());
        return "admin/pay/paychanneltype/list";
    }
    ...
    PageResult list(@RequestParam Map<String, Object> map, Integer pageNo, Integer pageSize, @RequestParam(value = "orders[]", required = false) String[] orders) {
        try {
            ...
            // 分页查询
            payChannelTypeService.queryPage(map, page, orders);
     ...
     * @since 2020-6-29
     */
    @AdminPermission(value = {"admin:paychanneltype:add"})
    @RequestMapping("/add")
    public String add() {
        return "admin/pay/paychanneltype/edit";
    }
    ...
    public @ResponseBody
    Message addSave(PayChannelType payChannelType) {
        //数据验证
        ...
        try {
            ...
            payChannelTypeService.addSave(payChannelType);
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @since 2020-6-29
     */
    @AdminPermission(value = {"admin:paychanneltype:edit"})
    @RequestMapping("/edit")
    public String edit(Integer id, Model model) {
        ...
        params.put("id", id);
        //获取需要修改的记录数据
        PayChannelType result = payChannelTypeService.querySingle(params);
        if (result == null) {
    ...
    public @ResponseBody
    Message editSave(PayChannelType payChannelType) {
        //数据验证
        if (payChannelType == null) {
            return Message.error("参数错误");
        }
        ...
        try {
            ...
            payChannelTypeService.editSave(payChannelType);
        } catch (Exception e) {
            e.printStackTrace();
            return Message.error();
        }
     ...
     * @since 2020-6-29
     */
    @AdminPermission(value = {"admin:paychanneltype:delete"})
    ...
    Message delete(@RequestParam(value = "ids[]") Long[] ids) {
        ...
        try {
            ...
            payChannelTypeService.delete(ids);
        } catch (Exception e) {
            e.printStackTrace();
            return Message.error();
        }
