...
import com.city.city_collector.admin.pay.dao.PayExcelexportDao;
...
/**
 * Description:Excel导出-service实现类
 *
 * @author demo
 * @version 1.0
 * @since 2020-6-29
 */
@Service
public class PayExcelexportServiceImpl implements PayExcelexportService {

    @Autowired
    PayExcelexportDao payExcelexportDao;
    ...
    public Page queryPage(Map<String, Object> params, Page page, String[] orders) {
        //获取记录总数
        int total = payExcelexportDao.queryCount(params);
        page.setTotal(total);
        ...
        //获取分页数据
        page.setResults(payExcelexportDao.queryPage(params));
        return page;
    }
    ...
    public void addSave(PayExcelexport payExcelexport) {
        payExcelexportDao.addSave(payExcelexport);
    }
    ...
    public PayExcelexport querySingle(Map<String, Object> params) {
        return payExcelexportDao.querySingle(params);
    }
    ...
    public void editSave(PayExcelexport payExcelexport) {
        payExcelexportDao.editSave(payExcelexport);
    }
    ...
    public void delete(Long[] ids) {
        ...
        payExcelexportDao.delete(ids_str);
    }
}
