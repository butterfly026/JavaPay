...
import com.city.city_collector.admin.pay.dao.PayClientDao;
...
public class PayClientServiceImpl implements PayClientService {
    ...
    public Page queryPage(Map<String, Object> params, Page page, String[] orders) {
        //获取记录总数
        int total = payClientDao.queryCount(params);
        page.setTotal(total);
        ...
        //获取分页数据
        page.setResults(payClientDao.queryPage(params));
        return page;
    }
    ...
    public void addSave(PayClient payClient) {
        payClientDao.addSave(payClient);
    }
    ...
    public PayClient querySingle(Map<String, Object> params) {
        return payClientDao.querySingle(params);
    }
    ...
    public void delete(Long[] ids) {
        ...
        payClientDao.delete(ids_str);
    }

    public List<SysUser> querySelectList() {
        return payClientDao.querySelectList();
    }

    public void updatePayword(SysUser sysUser) {
        payClientDao.updatePayword(sysUser);
    }
}
