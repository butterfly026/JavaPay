 ...
 * 卓合
 */
public class ZhongYuanPayClientTest extends ClientTest {

    public ZhongYuanPayClientTest() {
        merchantNo = "210921261";
        merchantMy = "yevns1psxeow28evxpnprtrloudae8yl";
        payUrl = "http://tue.zhongyuanpay.top/Pay_Index.html";
        cashUrl = "";
