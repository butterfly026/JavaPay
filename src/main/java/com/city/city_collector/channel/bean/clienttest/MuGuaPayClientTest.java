 ...
 * 对接上游示例
 */
public class MuGuaPayClientTest extends ClientTest {

    //1. 商户资料
    public MuGuaPayClientTest() {
        /**
         * 商户号
         */
        merchantNo = "9111" ;
         ...
         * 商户秘钥
         */
        merchantMy = "ae3fea2ea29a4423b1a316aada54545a" ;
        /**
         * 下单url
         */
        payUrl = "http://api.mypay86.com/api/startOrder" ;
        //???
        cashUrl = "" ;
        /**
         * 通道参数: 上游多通道使用
        ...
        channelParams.put("payType", "alipay");
//        {"payType":"alipay"}
    }
...
//            params.put("CategoryCode", "138");
        ...
        params.put("merchantNum", merchantNo);
        ...
        sbuf.append(sn);
        sbuf.append(amountValue);
        sbuf.append(notifyUrl);
    ...
    public OrderInfo dealOrderData(String data, Long clientId, String clientNo, String clientName,
        ...
        oi.setData(data);
        oi.setSn(sn);
        oi.setPayUrl(jobj.get("data").getAsString());
        oi.setName("");
        oi.setCard("");
        oi.setBankName("");
    ...
    public NotifyInfo notifyData(Map<String, Object> params, String merchantNo, String merchantMy,
        ...
        try {
            ...
            StringBuffer sbuf = new StringBuffer("");
            sbuf.append(params.get("state").toString());
            sbuf.append(params.get("merchantNum").toString());
            sbuf.append(params.get("orderNo").toString());
            sbuf.append(params.get("amount").toString());
            sbuf.append(merchantMy);

            String anObject = MD5Util.MD5Encode(sbuf.toString(), "UTF-8").toLowerCase();
            if (sign.equals(anObject)) {
                NotifyInfo ni = new NotifyInfo();
                ni.setSn(params.get("orderNo").toString());
                ni.setClientSn(params.get("platformOrderNo").toString());
