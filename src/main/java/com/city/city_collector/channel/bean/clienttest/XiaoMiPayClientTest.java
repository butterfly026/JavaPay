...
public class XiaoMiPayClientTest extends ClientTest {

    public XiaoMiPayClientTest() {
        merchantNo = "";
        merchantMy = "";
        payUrl = "http://pay.axc.qcx.ink/api/pay/create_order";
        cashUrl = "";
        channelParams = new HashMap<String, Object>();
//            {"productId":"8031"}
        channelParams.put("productId", "8023");
    }
    ...
    public NotifyInfo notifyData(Map<String, Object> params, String merchantNo, String merchantMy,
        ...
        try {
//            success
            if(!"2".equalsIgnoreCase(params.get("status").toString())){
                return null;
            }
