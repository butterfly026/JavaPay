 ...
 * 对接上游示例
 */
public class BaoChengPayClientTest extends ClientTest {

    //1. 商户资料
    public BaoChengPayClientTest() {
        /**
         * 商户号
         */
        merchantNo = "1546" ;
         ...
         * 商户秘钥
         */
        merchantMy = "xbvmeqgpxp44rf2gstq0vume6re6xe8q" ;
        /**
         * 下单url
         */
        payUrl = "http://api.bojingpay.com/pay-api/api/h5Request" ;
        //???
        cashUrl = "" ;
        /**
         * 通道参数: 上游多通道使用
        ...
        channelParams.put("tradeType","WXH5");
//        {"tradeType":"WXH5"}
    }
...
//            params.put("CategoryCode", "138");
        ...
        params.put("subject","buyproduct");
        params.put("body","buybody");
...
//        System.out.println(sign);
    ...
    public OrderInfo dealOrderData(String data, Long clientId, String clientNo, String clientName,
        ...
        oi.setData(data);
        oi.setSn(sn);
        oi.setPayUrl(jobj.get("src").getAsString());
        oi.setName("");
        oi.setCard("");
        oi.setBankName("");
...
//            SUCCESS
            ...
            params.put("merchantNo", jobj.get("merchantNo").getAsString());
            params.put("timestamp", jobj.get("timestamp").getAsString());
            params.put("orderNo", jobj.get("orderNo").getAsString());
            params.put("trxAmt", jobj.get("trxAmt").getAsString());
            params.put("settleAmt", jobj.get("settleAmt").getAsString());
            ...
            if(!"0000".equals(params.get("status").toString())){
                return null;
            }
            ...
            sbuf.append("key=" + merchantMy);
            sbuf.append(params.get("timestamp"));

            String signStr = sbuf.toString();
//            System.out.println(signStr);
            String anObject = MD5Util.MD5Encode(signStr, "UTF-8").toLowerCase();
