...
public class superPayClientTest extends ClientTest {
    public superPayClientTest() {
        merchantNo = "";
        merchantMy = "";
        payUrl = "http://api.superpay.pro/api/pay/order";
        queryUrl = "";
        cashUrl = "";
    ...
    public OrderInfo dealOrderData(String data, Long clientId, String clientNo, String clientName,
        ...
        if (!"success".equals(jobj.get("msg").getAsString())) {
            return null;
        }
