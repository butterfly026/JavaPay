...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${context}/lib/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="${context}/lib/webuploader/style.css?1">
    <!--引入JS-->
                ...
                <select name="folderId" id="folderId">
                    <c:forEach var="list" items="${folderList}">
                        <option value="${list.id}"
                                <c:if test="${list.id==folderId}">selected</c:if>>${list.name}</option>
                    </c:forEach>
                </select>
            </div>
        </div>
    ...
    (function ($) {
        ...
        $(function () {
            ...
            if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
                ...
                if (flashVersion) {
                    (function (container) {
                        ...
                        var swf = '${context}/lib/webuploader/expressInstall.swf';
                        // insert flash object
            ...
            uploader = WebUploader.create({
                ...
                dnd: '#dndArea',
                paste: '#uploader',
                swf: '${context}/lib/webuploader/Uploader.swf',
                chunked: false,
                chunkSize: 512 * 1024,
                server: 'addSave',
                // runtimeOrder: 'flash',
            ...
            uploader.on('uploadBeforeSend', function (object, data, header) {
                ...
                if (window.parent.updateFolderId) window.parent.updateFolderId($("#folderId").val());
            });
            ...
            function updateStatus() {
                ...
                if (state === 'ready') {
                    ...
                    if (stats.uploadFailNum) {
                        text = '已成功上传' + stats.successNum + '张图片至，' + $("#folderId").find("option:selected").text() +
                            stats.uploadFailNum + '张图片上传失败，<a class="retry" style="color:#ff0000;" href="#">重新上传</a>失败图片';
                    }
            ...
            $info.on('click', '.ignore', function () {//忽略当前文件
                //alert( 'todo' );
