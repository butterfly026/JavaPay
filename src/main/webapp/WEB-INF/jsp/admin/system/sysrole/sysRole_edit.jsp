...
<div class="admin-main">
    <form id="editForm" class="layui-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><span class="span-red">*</span>角色名</label>
            <div class="layui-input-block">
                <input type="text" name="name" id="username" lay-verify="required" lay-verType="tips" placeholder="角色名"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="desc" id="descID" placeholder="角色描述" autocomplete="off" class="layui-input"
                       value="${result.desc}"/>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    ...
    $(function () {
        layui.use(['form', 'layer'], function () {
            ...
            //自定义表单验证
            /* form.verify({
                rname:function(value,item){//验证角色名是否为空
