...
<div class="admin-main">
    <fieldset class="layui-elem-field admin-search-form">
        <legend class="admin-search-title">上游代付查询</legend>
    ...
    <div class="admin-btns">
        <adminPermission:hasPermission permission="admin:payclientcash:add">
    ...
    <script type="text/html" id="tpl_opera">
        <adminPermission:hasPermission permission="admin:payclientcash:edit">
            <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit">编辑</a>
        </adminPermission:hasPermission>
        <adminPermission:hasPermission permission="admin:payclientcash:delete">
