    ...
    <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-sm12 layui-col-md6">
            <fieldset class="layui-elem-field admin-search-form">
                <legend class="admin-search-title">通道数据</legend>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code == 200) {
                    ...
                    $str += '<tr><td width="20%"><b>下单链接</b></td><td width="80%"><a href="' + $r.payUrl + '" target="_blank" style="color:#1E9FFF;">' + pu + '</a></td></tr>';

                    pu = $r.result;
                    if (pu) {
                        pu = pu.replace("script", "*");
                    }

                    $str += '<tr><td width="20%"><b>接口返回数据</b></td><td width="80%"><pre>' + pu + '</pre></td></tr>';

                    pu = $r.responseData;
                    if (pu) {
                        pu = pu.replace("script", "*");
                    }
                    $str += '<tr><td width="20%"><b>上游响应数据</b></td><td width="80%"><pre>' + pu + '</pre></td></tr>';

                    pu = $r.dealResult;
                    if (pu) {
                        pu = pu.replace("script", "*");
                    }
                    $str += '<tr><td width="20%"><b>处理结果</b></td><td width="80%"><pre>' + pu + '</pre></td></tr>';

                    $str += '<tr><td width="20%"><b>上游请求数据</b></td><td width="80%"><pre>' + $r.requstData + '</pre></td></tr>';

                    pu = $r.result;
                    if (pu) {
                        pu = pu.replace("script", "*");
                    }
                    $str += '<tr><td width="20%"><b>接口返回数据</b></td><td width="80%" style="color:green;"><pre>' + pu + '</pre></td></tr>';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code == 200) {
                    ...
                    $str += '<td width="20%"><b>通道名</b></td><td width="30%">' + $r.name + '</td></tr>';
