...
<div class="admin-main">
    <fieldset class="layui-elem-field admin-search-form">
        <legend class="admin-search-title">明细查询</legend>
    ...
    <div class="admin-btns">
        ...
        <adminPermission:hasPermission permission="admin:payclientbalance:add">
    ...
    <script type="text/html" id="tpl_opera">
        <adminPermission:hasPermission permission="admin:payclientbalance:edit">
            <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit">编辑</a>
        </adminPermission:hasPermission>
        <adminPermission:hasPermission permission="admin:payclientbalance:delete">
        ...
        layui.use(['table', 'layer', 'laydate'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'clientNo', title: '上游号', width: 120}
                    , {field: 'orderSn', title: '关联订单', width: 180}
                    ...
                    <adminPermission:hasPermission permission="admin:payclientbalance:remark">
