...
<div class="admin-main">
    <form id="editForm" class="layui-form">
        ...
        <div style="color:red;width:90%;padding-left:20px;">1、填写要充值的金额，提交后通知客服</div>
        <div style="color:red;width:90%;padding-left:20px;">2、客服分配收款账号并告知您</div>
        <div style="color:red;width:90%;padding-left:20px;padding-bottom:10px;">3、向收款账号转账后告知客服，客服确认收款后，充值金额会自动增加到您的余额
        </div>
