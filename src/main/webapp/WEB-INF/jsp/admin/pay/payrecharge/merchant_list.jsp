...
<div class="admin-main">
    ...
    <div class="admin-btns">
        <adminPermission:hasPermission permission="admin:payrecharge:merchantAdd">
    ...
    <script type="text/html" id="tpl_opera">
        ...
        {{# if(d.status==2){ }}
        <adminPermission:hasPermission permission="admin:payrecharge:merchantPaysuc">
            <a class="layui-btn layui-btn-xs layui-btn-blue" lay-event="paysuc">已充值</a>
        </adminPermission:hasPermission>
        {{# } }}

        <adminPermission:hasPermission permission="admin:payrecharge:merchantdetail">
    ...
    function paysuc(id) {
        ...
        layer.open({
            ...
            , yes: function (index) {
                ...
                commReq('paysuc', {id: id, remark: remark}, function () {
                    layer.close(index);
                    searchData();
                });
