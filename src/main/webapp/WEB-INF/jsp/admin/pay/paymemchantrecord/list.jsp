...
<div class="admin-main">
    ...
    <div class="admin-btns">
        ...
        <adminPermission:hasPermission permission="admin:paymemchantrecord:export">
        ...
        <adminPermission:hasPermission permission="admin:paymemchantrecord:add">
            <button class="layui-btn layui-btn-sm layui-btn-normal" onclick="add_add();">
                增加商户余额
            </button>
        </adminPermission:hasPermission>
        <adminPermission:hasPermission permission="admin:paymemchantrecord:add">
            <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="add();">
                扣减商户余额
            </button>
        </adminPermission:hasPermission>
    ...
    <script type="text/html" id="tpl_opera">
        <adminPermission:hasPermission permission="admin:paymemchantrecord:edit">
            <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit">编辑</a>
        </adminPermission:hasPermission>
        <adminPermission:hasPermission permission="admin:paymemchantrecord:delete">
    ...
    <script type="text/html" id="tpl_sn">
        ...
        {{# }else{ }}
        <a style="color:green;">{{d.orderSn}}</a>
        {{# } }}
    </script>
        ...
        layui.use(['table', 'layer', 'laydate'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'remark1', title: '备注', width: 120}
                    , {field: 'reason', title: '调账原因', width: 120, templet: '#tpl_reason'}

                    <adminPermission:hasPermission permission="admin:paymemchantrecord:remark">
