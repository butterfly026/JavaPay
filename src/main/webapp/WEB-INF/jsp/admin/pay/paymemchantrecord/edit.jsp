        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="money" id="money" lay-verify="required|number" lay-verType="tips"
                       placeholder="调账金额，只能填负数" autocomplete="off" class="layui-input"/>
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label"><span class="span-red">*</span>验证码</label>
            <div class="layui-input-block">
                <input type="number" name="key" id="key" lay-verify="required|number" lay-verType="tips"
