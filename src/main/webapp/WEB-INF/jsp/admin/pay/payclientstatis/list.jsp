...
<div class="admin-main">
    <fieldset class="layui-elem-field admin-search-form">
        <legend class="admin-search-title">上游统计查询</legend>
    ...
    <div class="admin-btns">
        ...
        <adminPermission:hasPermission permission="admin:payclientstatis:export">
    ...
    <script type="text/html" id="tpl_opera">
        <adminPermission:hasPermission permission="admin:payclientstatis:edit">
            <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit">编辑</a>
        </adminPermission:hasPermission>
        <adminPermission:hasPermission permission="admin:payclientstatis:delete">
...
<script type="text/javascript">
        ...
        layui.use(['table', 'layer', 'laydate'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'clientno', title: '上游账号', width: 180, sort: true}
    ...
    var exportObj = [
        [ //表头
            {field: 'clientno', title: '商户号', width: 30, rowspan: 1, colspan: 1},
