...
<div class="admin-main">
    <form id="editForm" class="layui-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><span class="span-red">*</span>通道编码</label>
            <div class="layui-input-block">
                <input type="text" name="code" id="code" lay-verify="required" lay-verType="tips" placeholder="通道编码"
                       autocomplete="off" class="layui-input" value="${result.code}"/>
            </div>
        </div>
