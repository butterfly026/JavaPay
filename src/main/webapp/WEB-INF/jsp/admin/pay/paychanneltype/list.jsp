...
<div class="admin-main">
    <fieldset class="layui-elem-field admin-search-form">
        <legend class="admin-search-title">通道类型查询</legend>
        <form id="searchForm" class="layui-form">
            <div class="layui-row admin-search-row">
                ...
                <div class="layui-col-xs2 layui-col-sm2 layui-col-md2">
                    <input type="text" name="code" id="code" placeholder="通道编码" class="layui-input"/>
                </div>
    ...
    <div class="admin-btns">
        <adminPermission:hasPermission permission="admin:paychanneltype:add">
        ...
        layui.use(['table', 'layer'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'code', title: '通道编码', width: 120}
                    , {field: 'name', title: '通道名', width: 120}

                    , {field: 'descript', title: '通道描述', width: 250}
