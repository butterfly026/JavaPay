...
<div class="admin-main">
    <fieldset class="layui-elem-field admin-search-form">
        <legend class="admin-search-title">Paytm收款通道查询</legend>
        <form id="searchForm" class="layui-form">
            <div class="layui-row admin-search-row">
                ...
                <div class="layui-col-xs2 layui-col-sm2 layui-col-md2">
                    <input type="text" name="paytmid" id="paytmid" placeholder="paytm商户ID" class="layui-input"/>
                </div>
        ...
        layui.use(['table', 'layer', 'dropdown'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'clientNo', title: '所属收款平台', width: 120}
                    , {field: 'paytmid', title: 'paytm商户ID', width: 120}
