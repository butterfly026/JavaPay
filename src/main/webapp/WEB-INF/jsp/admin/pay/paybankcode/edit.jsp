...
<div class="admin-main">
    <form id="editForm" class="layui-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><span class="span-red">*</span>银行编码</label>
            <div class="layui-input-block">
                <input type="text" name="code" id="code" lay-verify="required" lay-verType="tips" placeholder="银行编码"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" lay-verify="required" lay-verType="tips" placeholder="银行名"
