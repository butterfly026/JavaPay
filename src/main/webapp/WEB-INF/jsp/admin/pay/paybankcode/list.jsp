...
<div class="admin-main">
    <fieldset class="layui-elem-field admin-search-form">
        <legend class="admin-search-title">银行编码查询</legend>
        <form id="searchForm" class="layui-form">
            <div class="layui-row admin-search-row">

                <div class="layui-col-xs2 layui-col-sm2 layui-col-md2">
                    <input type="text" name="code" id="code" placeholder="银行编码" class="layui-input"/>
                </div>
    ...
    <div class="admin-btns">
        <adminPermission:hasPermission permission="admin:paybankcode:add">
    ...
    <script type="text/html" id="tpl_opera">
        <adminPermission:hasPermission permission="admin:paybankcode:edit">
            <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="edit">编辑</a>
        </adminPermission:hasPermission>
        <adminPermission:hasPermission permission="admin:paybankcode:delete">
        ...
        layui.use(['table', 'layer'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'code', title: '银行编码', width: 120, sort: true}
                    , {field: 'name', title: '银行名', width: 120, sort: true}
