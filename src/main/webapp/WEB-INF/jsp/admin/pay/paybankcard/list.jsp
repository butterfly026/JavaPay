...
<div class="admin-main">
    ...
    <div class="admin-btns">
        ...
        <adminPermission:hasPermission permission="admin:paybankcard:delete">
        ...
        layui.use(['table', 'layer'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    //,{field:'bankCode', title: '银行编码', width:150}
                    ...
                    //,{field:'cardId', title: '身份证', width:150}
                    //,{field:'cardMobile', title: '手机号码', width:120}

                    , {field: 'userNo', title: '所属用户', width: 120}

                    , {fixed: 'right', align: 'center', title: '操作', toolbar: '#tpl_opera', width: 120}
                ]]
            });
