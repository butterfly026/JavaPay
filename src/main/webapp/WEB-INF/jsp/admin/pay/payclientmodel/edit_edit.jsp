        ...
        <div class="layui-tab" lay-filter="mytabs">
            ...
            <div class="layui-tab-content">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="notifystr" id="notifystr" lay-verify="required" lay-verType="tips"
                                   ...
                                   value="<c:out value="${result.notifystr}"></c:out>"
                            />
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="status" id="status" lay-verify="required">
                                <option value="1"
                                        <c:if test='${result.status==1}'>selected</c:if> >启用
                                </option>
                                <option value="0"
                                        <c:if test='${result.status==0}'>selected</c:if> >禁用
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="reqType" id="reqType" lay-verify="required">
                                <option value="0"
                                        <c:if test='${result.reqType==0}'>selected</c:if> >普通表单
                                </option>
                                <option value="1"
                                        <c:if test='${result.reqType==1}'>selected</c:if> >JSON
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="reqpage" style="width:100%;height:100px;"
                                      id="reqpage">${data.reqpage }</textarea>
                        </div>
                    </div>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div style="color:red;">请在此处完成签名等操作,返回Map,可使用的参数
                                ...
                                <br/><br/></div>
                            <div style="color:green;">Map
                                createReqParams(id,merchantNo,merchantMy,channelParams,sn,amount,domain){
                            </div>
                            <textarea name="reqprogram" style="width:100%;height:300px;"
                                      id="reqprogram">${data.reqprogram}</textarea>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<textarea name="rsppage" style="width:100%;height:100px;" id="rsppage">${data.rsppage}</textarea>
				</div>
			</div>
			 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="rspprogram" style="width:100%;height:200px;"
                                      id="rspprogram">${data.rspprogram}</textarea>
                            <div style="color:red;">}</div>
                        </div>
                    </div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<textarea name="ntpage" style="width:100%;height:100px;" id="ntpage">${data.ntpage}</textarea>
				</div>
			</div>
			-->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="ntprogram" style="width:100%;height:200px;"
                                      id="ntprogram">${data.ntprogram }</textarea>
                            <div style="color:red;">}</div>
                        </div>
                    </div>
		    ...
		    <div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<textarea name="treqpage" style="width:100%;height:100px;" id="treqpage">${data.treqpage }</textarea>
				</div>
			</div>
			-->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="treqprogram" style="width:100%;height:200px;"
                                      id="treqprogram">${data.treqprogram }</textarea>
                            <div style="color:red;">}</div>
                        </div>
                    </div>
		    ...
		    <div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div style="color:red;">此处导入的包用于生成请求参数的程序</div>
					<textarea name="payreqpage" style="width:100%;height:100px;" id="payreqpage">${data.payreqpage }</textarea>
				</div>
			</div>
			-->
                    <div class="layui-form-item">
                        <label class="layui-form-label">请求参数生成程序</label>
                        <div class="layui-input-block">
                            <div style="color:red;">参数 PayCash cash,SysUser client,String domain,String urlcash,String
                                keyname(键名)。
                                <br/><br/></div>
                            ...
                            <textarea name="payreqprogram" style="width:100%;height:200px;"
                                      id="payreqprogram">${data.payreqprogram }</textarea>
                            <div style="color:red;">}</div>
                        </div>
                    </div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div style="color:red;">此处导入的包用于代付返回数据处理程序</div>
					<textarea name="payrsppage" style="width:100%;height:100px;" id="payrsppage">${data.payrsppage }</textarea>
				</div>
			</div>
			-->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="payrspprogram" style="width:100%;height:200px;"
                                      id="payrspprogram">${data.payrspprogram }</textarea>
                            <div style="color:red;">}</div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="queryreqprogram" style="width:100%;height:200px;"
                                      id="queryreqprogram">${data.queryreqprogram }</textarea>
                            <div style="color:red;">}</div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="queryrspprogram" style="width:100%;height:200px;"
                                      id="queryrspprogram">${data.queryrspprogram }</textarea>
                            <div style="color:red;">}</div>
                        </div>
                    </div>
