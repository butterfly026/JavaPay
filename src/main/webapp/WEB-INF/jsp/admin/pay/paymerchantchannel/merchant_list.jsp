...
<div class="admin-main">
    ...
    <script type="text/html" id="tpl_opera">
        ...
        <adminPermission:hasPermission permission="admin:paymerchantchannel:fpsy">
            <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="fpsy">分配上游通道</a>
        </adminPermission:hasPermission>
    </script>
...
<script type="text/javascript">
        ...
        layui.use(['table', 'layer'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'name', title: '通道名', width: 130}
                    , {field: 'typeName', title: '支付平台', width: 120}

                    , {field: 'merchantRatio', title: '商户费率', width: 120, templet: '#tpl_merchantRatio'}
    ...
    //给角色分配用户
    function allocateClientChannel(id) {
        if (typeof id == 'undefined') {
            layer.msg("请选择角色");
            return;
        }
